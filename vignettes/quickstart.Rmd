...
The `end_year` parameter refers to the spring semester year. For example, `end_year = 2024` fetches data for the 2023-24 school year.
...
- See the function reference for detailed documentation: `?fetch_enr`, `?tidy_enr`
