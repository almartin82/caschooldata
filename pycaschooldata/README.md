...
Python wrapper for California school enrollment data.

This is a thin rpy2 wrapper around the [caschooldata](https://github.com/almartin82/caschooldata) R package. It provides the same functionality but returns pandas DataFrames.

## Requirements

- Python 3.9+
- R 4.0+
- The `caschooldata` R package installed
...
df_multi = ca.fetch_enr_multi([2020, 2021, 2022, 2023, 2024, 2025])
