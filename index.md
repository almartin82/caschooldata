...
Fetch and analyze California school enrollment, assessment, and
graduation data from the California Department of Education in R or
Python. 44 years of enrollment data (1982-2025), CAASPP assessment
results (2015-2024), and graduation rates (2017-2025) for 5.8 million
students across 1,000+ districts.
...
![State enrollment
trend](https://almartin82.github.io/caschooldata/articles/district-highlights_files/figure-html/finding-1-1.png)
...
|--------------------|-----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| **Enrollment**     | 1982-2025 | [`fetch_enr()`](https://almartin82.github.io/caschooldata/reference/fetch_enr.md) / [`fetch_enr_multi()`](https://almartin82.github.io/caschooldata/reference/fetch_enr_multi.md)                             | State, county, district, school. Race, gender, EL, FRPL, SpEd |
| **Assessments**    | 2015-2024 | [`fetch_assess()`](https://almartin82.github.io/caschooldata/reference/fetch_assess.md) / [`fetch_assess_multi()`](https://almartin82.github.io/caschooldata/reference/fetch_assess_multi.md)                 | CAASPP ELA & Math. Grades 3-8, 11. State, district, school    |
| **Graduation**     | 2017-2025 | [`fetch_graduation()`](https://almartin82.github.io/caschooldata/reference/fetch_graduation.md) / [`fetch_graduation_multi()`](https://almartin82.github.io/caschooldata/reference/fetch_graduation_multi.md) | 4-yr, 5-yr, 6-yr cohort. State, county, district, school      |
...
> See
> [DATA-CATEGORY-TAXONOMY.md](https://almartin82.github.io/caschooldata/DATA-CATEGORY-TAXONOMY.md)
...
- [Full documentation](https://almartin82.github.io/caschooldata/)
- [Enrollment
  trends](https://almartin82.github.io/caschooldata/articles/district-highlights.html)
  — 10 stories
- [Assessment
  analysis](https://almartin82.github.io/caschooldata/articles/california-assessment.html)
  — 15 stories
- [Graduation
  rates](https://almartin82.github.io/caschooldata/articles/graduation-rates.html)
- [Function
  reference](https://almartin82.github.io/caschooldata/reference/)
...
- **Cohort Types**: 4-year, 5-year, 6-year adjusted cohort graduation
  rates
