...
Over 1,000 districts. Here are ten stories hiding in the numbers:
...
![40-year enrollment arc](reference/figures/enrollment-40yr.png)
...
![Demographic transformation](reference/figures/demographics-30yr.png)
...
![K vs 12th grade](reference/figures/k-vs-12.png)
...
![COVID impact by grade](reference/figures/covid-grades.png)
...
![Bay Area vs SoCal](reference/figures/bayarea-socal.png)
...
![Gender by grade](reference/figures/gender-grades.png)
...
![Student groups](reference/figures/student-groups.png)
...
![LAUSD decline](reference/figures/lausd-longterm.png)
...
![Race by district](reference/figures/race-by-district.png)
