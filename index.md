...
to official state DOE data with a consistent API across all 50 states.
...
California’s demographic makeup has shifted significantly over the past
few decades.
...
statewide trend with substantial growth since 2020.
...
Enrollment loss varied significantly by grade level, with high schools
seeing the earliest and steepest declines.
...
of the steepest enrollment drops percentage-wise.
...
constant at roughly 51% male, 49% female.
...
English Learners represent approximately 18% of California’s student
population (data available for 2024-2025).
...
vastly different demographic compositions: majority Hispanic in LA and
